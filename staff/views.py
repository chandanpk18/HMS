...
# Configure your API key (ensure it's secure and not exposed publicly)
genai.configure(api_key="AIzaSyDAv4UEGoc2BuZjff7H1GdKsbxILPgIZnY")
model = genai.GenerativeModel("gemini-1.5-flash")

# This view will render the chatbot page (gemini.html)
def gemini(request):
